...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'baixing', // 您的昵称 例如 tangly1024
  ...
  // 文章列表相关设置
  CAN_COPY: process.env.NEXT_PUBLIC_CAN_COPY || true, // 是否允许复制页面内容 默认允许 true，如果设置为false、则全栈禁止复制内容。
